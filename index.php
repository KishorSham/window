...
<div class="carousel-inner">
    <div class="carousel-item active">
        <img src="html/images/banner_1.jpg" alt="banner" style="width: 100%; height: 400px;">
    </div>
    <div class="carousel-item">
        <img src="html/images/banner_2.jpg" alt="banner" style="width: 100%; height: 400px;">
    </div>
    <div class="carousel-item">
        <img src="html/images/banner_3.jpg" alt="banner" style="width: 100%; height: 400px;">
    </div>
    <div class="carousel-item">
        <img src="html/images/banner_4.jpg" alt="banner" style="width: 100%; height: 400px;">
    </div>
</div>
...
<div class="container" id="about">
    <div class="row">
        <div class="col-md-12 contact text-center" >Contact Us</div>
    </div>
    <div class="row">
        <div class="col-md-6">
            <h4>Window Creation</h4>
            <p>Door no : #1215, 2nd Floor, 3rd Stage, A Block, <br/>
            Street Name: Kanakadasa Nagar, Dattagalli, <br/>  
            Landmark :  <br/>
            Mysuru, Karnataka, Pincode - 570023<br/>
            Phone number<br/>
            Email : connect@windowcreation.com</p>
        </div>
